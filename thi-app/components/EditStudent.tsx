...
export const EditStudent: React.FC<EditStudentProps> = ({ toggleEditStudent }) => {
  ...
  return (
    ...
    >
      <View className="flex flex-row bg-[#105366] h-[64px] items-center justify-between px-6">
        <Text className="text-white text-xl font-semibold">Edit Student</Text>
        <FontAwesome6 name="xmark" size={22} color="white" onPress={toggleEditStudent} />
      </View>
      ...
      <View className="absolute bottom-0 flex flex-row border-t w-full h-[64px] items-center justify-end gap-4 pr-4">
        <Text className="text-base color-[#105366] font-semibold" onPress={toggleEditStudent}>Cancel</Text>
        <TouchableOpacity className="shadow bg-[#105366] rounded-lg pt-2 pr-6 pl-6 pb-2" onPress={toggleEditStudent}>
