...
interface RemoveTeacherProps {
  toggleRemoveTeacher: () => void;
}

export const RemoveTeacher: React.FC<RemoveTeacherProps> = ({ toggleRemoveTeacher }) => {
  return (
    <View className="w-[444px] h-[196px] bg-white rounded-lg shadow-lg p-6">
      {/* Title */}
      <Text className="text-xl font-semibold">
        Would you like to delete this teacher?
      </Text>

      {/* Description */}
      <Text className="color-gray-500 text-lg font-light leading-snug pt-2">
        You will lose all history associated with this teacher. 
