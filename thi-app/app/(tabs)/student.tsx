      ...
      <ScrollView className="p-4">
        ...
        <View className="flex-row justify-between items-center mb-5">
          ...
          <View className="flex-row">
            <TouchableOpacity className="bg-[#17468F] p-2 rounded mr-2 flex-row items-center">
              <AntDesign name="plus" size={16} color="white" />
              <Text className="text-white font-bold ml-1">Add Student</Text>
            </TouchableOpacity>
            <TouchableOpacity className="bg-[#17468F] p-2 rounded flex-row items-center">
        ...
        {/* Student Cards Grid */}
        <View className="pt-2 flex-row flex-wrap justify-between">
          {students.map((student) => (
            <View key={student.id} className="w-[30%] my-4">
